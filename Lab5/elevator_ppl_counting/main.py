    ...
    def run(self):
        ...
        while True:
            ...
            if current_time - start_time >= 1:
                update_query = f"INSERT INTO people_counting (elevator_id, inside_count, outside_count, time) \
                                VALUES (1, {max_inside}, {ppl_outside - max_inside if elevator_doors_open else ppl_outside}, CURRENT_TIMESTAMP()) \
                                ON DUPLICATE KEY UPDATE \
                                inside_count = {max_inside}, \
